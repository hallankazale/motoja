...
createRoot(document.getElementById('root')!).render(<StrictMode><ThemeProvider><ErrorBoundary>{sharedToken ? <SharedRide token={sharedToken} /> : <App />}</ErrorBoundary></ThemeProvider></StrictMode>);
